...
exports.sendmail = function (req, res, user) {
  ...
  transport.sendMail(mailOptions, (err, info) => {
    ...
    user.save();
    return res.send(
      "<h1 style='text-align:center;color: black; margin-top:10%'><span style='font-size:80px;'>✅</span> <br />Email Sent! Check your inbox , <br/>check spam in case not found in inbox.</h1>"
    );
  });
};
